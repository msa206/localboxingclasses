...
export const metadata: Metadata = {
  title: 'Boxing Classes for Women in New York City, NY',
  description: 'Discover women-focused boxing classes in New York City. Empowering, supportive programs designed specifically for women.',
}

export default async function NewYorkWomenBoxingPage() {
  const stateAbbr = 'ny'
  ...
  const jsonLd = generateItemListJsonLd(
    ...
    'Boxing Classes for Women in New York City, NY'
  )
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-black mb-6">
            Boxing Classes for <span className="text-fight-red">Women</span> in NYC
          </h1>
          <p className="text-xl text-gray-600 mb-6 max-w-3xl">
            Discover empowering women-focused boxing programs in New York City. Join supportive communities where women train together, build strength, and develop confidence in the Big Apple.
          </p>
        ...
        <div className="bg-gray-50 rounded-lg p-8 mb-12 border border-gray-200">
          <h2 className="text-2xl font-bold text-black mb-6">Why Choose Women's Boxing in NYC?</h2>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-black mb-8">
            {gyms.length > 0
              ? `${gyms.length} Women's Boxing Programs in New York City`
              : 'Boxing Classes for Women in New York City'
            }
          </h2>
            ...
            {gyms.length > 0 ? (
              ...
              <div className="col-span-full">
                <EmptyState
                  ...
                  description="We couldn't find any boxing gyms with women-specific programs in New York City yet."
                  action={{
        ...
        <div className="bg-fight-red rounded-lg p-8 text-white text-center mb-12">
          ...
          <p className="text-lg mb-6 opacity-90">
            Contact these NYC gyms directly to learn about their women's boxing programs. Many offer beginner-friendly classes!
          </p>
