...
export const metadata: Metadata = {
  title: 'Boxing Gyms with Free Trials in New York City, NY',
  description: 'Discover boxing gyms offering free trials in New York City. Try before you commit with these Manhattan, Brooklyn, Queens, and Bronx boxing studios.',
}

export default async function NewYorkFreeTrialsPage() {
  const stateAbbr = 'ny'
  ...
  const jsonLd = generateItemListJsonLd(
    ...
    'Boxing Gyms with Free Trials in New York City'
  )
    ...
    <div className="min-h-screen" style={{backgroundColor: '#FFFFFF'}}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <Breadcrumbs items={[
          ...
          { label: 'New York City', href: '/ny/new-york' },
        ...
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-black mb-6">
            Boxing Gyms with <span className="text-fight-red">Free Trials</span> in NYC
          </h1>
          <p className="text-xl text-gray-600 mb-6 max-w-3xl">
            Experience the best of NYC boxing with no commitment! These New York City gyms offer free trial classes so you can test their training style, meet world-class coaches, and find your perfect fit in the Big Apple.
          </p>
        ...
        <div className="bg-gray-50 rounded-lg p-8 mb-12 border border-gray-200">
          <h2 className="text-2xl font-bold text-black mb-6">Why Try a Free Boxing Class in NYC?</h2>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-black mb-8">
            {gyms.length > 0
              ? `${gyms.length} Boxing Gyms Offering Free Trials in New York City`
              : 'Boxing Gyms with Free Trials in New York City'
            }
          </h2>
            ...
            {gyms.length > 0 ? (
              ...
              <div className="col-span-full">
                <EmptyState
                  ...
                  description="We couldn't find any boxing gyms offering free trials in New York City yet."
                  action={{
                    label: 'Browse all NYC gyms',
                    href: '/ny/new-york'
                  }}
                />
              </div>
        ...
        <div className="bg-fight-red rounded-lg p-8 text-white text-center mb-12">
          ...
          <p className="text-lg mb-6 opacity-90">
            Contact these NYC gyms directly to schedule your free trial class. Don't forget to ask about their beginner programs!
          </p>
