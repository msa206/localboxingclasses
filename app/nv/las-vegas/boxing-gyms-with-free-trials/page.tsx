...
export const metadata: Metadata = {
  title: 'Boxing Gyms with Free Trials in Las Vegas, Nevada',
  description: 'Discover boxing gyms offering free trials in Las Vegas, NV. Try before you commit with these premier boxing studios and martial arts centers.',
}

export default async function LasVegasFreeTrialsPage() {
  const stateAbbr = 'nv'
  const citySlug = 'las-vegas'
  ...
  const jsonLd = generateItemListJsonLd(
    ...
    'Boxing Gyms with Free Trials in Las Vegas, Nevada'
  )
    ...
    <div className="min-h-screen" style={{backgroundColor: '#FFFFFF'}}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <Breadcrumbs items={[
          ...
          { label: 'Nevada', href: '/nv' },
          { label: 'Las Vegas', href: '/nv/las-vegas' },
        ...
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-black mb-6">
            Boxing Gyms with <span className="text-fight-red">Free Trials</span> in Las Vegas
          </h1>
          <p className="text-xl text-gray-600 mb-6 max-w-3xl">
            Experience Las Vegas' premier boxing gyms risk-free! These gyms offer free trial classes so you can test their training methods, meet world-class coaches, and find your perfect fit in the Entertainment Capital.
          </p>
        ...
        <div className="bg-gray-50 rounded-lg p-8 mb-12 border border-gray-200">
          <h2 className="text-2xl font-bold text-black mb-6">Why Try a Free Boxing Class in Las Vegas?</h2>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-black mb-8">
            {gyms.length > 0
              ? `${gyms.length} Boxing Gyms Offering Free Trials in Las Vegas`
              : 'Boxing Gyms with Free Trials in Las Vegas'
            }
          </h2>
            ...
            {gyms.length > 0 ? (
              ...
              <div className="col-span-full">
                <EmptyState
                  ...
                  description="We couldn't find any boxing gyms offering free trials in Las Vegas yet."
                  action={{
                    label: 'Browse all Las Vegas gyms',
                    href: '/nv/las-vegas'
                  }}
                />
              </div>
        ...
        <div className="bg-fight-red rounded-lg p-8 text-white text-center mb-12">
          ...
          <p className="text-lg mb-6 opacity-90">
            Contact these Las Vegas gyms directly to schedule your free trial class. Don't forget to ask about their beginner programs!
          </p>
