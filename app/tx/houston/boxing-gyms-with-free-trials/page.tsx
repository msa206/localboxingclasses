...
export const metadata: Metadata = {
  title: 'Boxing Gyms with Free Trials in Houston, Texas',
  description: 'Discover boxing gyms offering free trials in Houston, TX. Try before you commit with these local boxing studios and martial arts centers.',
}

export default async function HoustonFreeTrialsPage() {
  const stateAbbr = 'tx'
  ...
  const jsonLd = generateItemListJsonLd(
    ...
    'Boxing Gyms with Free Trials in Houston, Texas'
  )
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-black mb-6">
            Boxing Gyms with <span className="text-fight-red">Free Trials</span> in Houston
          </h1>
          <p className="text-xl text-gray-600 mb-6 max-w-3xl">
            Experience Houston's best boxing gyms risk-free! These gyms offer free trial classes so you can test their training methods, meet the coaches, and find your perfect fit in Space City.
          </p>
        ...
        <div className="bg-gray-50 rounded-lg p-8 mb-12 border border-gray-200">
          <h2 className="text-2xl font-bold text-black mb-6">Why Try a Free Boxing Class in Houston?</h2>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-black mb-8">
            {gyms.length > 0
              ? `${gyms.length} Boxing Gyms Offering Free Trials in Houston`
              : 'Boxing Gyms with Free Trials in Houston'
            }
          </h2>
            ...
            {gyms.length > 0 ? (
              ...
              <div className="col-span-full">
                <EmptyState
                  ...
                  description="We couldn't find any boxing gyms offering free trials in Houston yet."
                  action={{
        ...
        <div className="bg-fight-red rounded-lg p-8 text-white text-center mb-12">
          ...
          <p className="text-lg mb-6 opacity-90">
            Contact these Houston gyms directly to schedule your free trial class. Don't forget to ask about their beginner programs!
          </p>
