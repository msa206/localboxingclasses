...
// Mock data for Los Angeles gyms with free trials
// In a real implementation, this would come from your Supabase database
const freeTrialGyms = [
  {
    id: 1,
    name: "LA Boxing Academy",
    site: "https://laboxingacademy.com",
    phone_number: "(323) 555-0123",
    ...
    review_count: 45,
    review_stars: 4.8,
    working_hours: "Mon-Fri: 6AM-10PM, Sat-Sun: 8AM-6PM",
    latitude: 34.0983,
    longitude: -118.3267,
    source_url: "https://laboxingacademy.com"
  },
  {
    id: 2,
    name: "Hollywood Boxing Club",
    site: "https://hollywoodboxing.com",
    phone_number: "(323) 555-0234",
    full_address: "456 Hollywood Blvd, Los Angeles, CA 90028",
    ...
    review_count: 67,
    review_stars: 4.6,
    working_hours: "Mon-Fri: 5AM-11PM, Sat-Sun: 7AM-8PM",
    latitude: 34.1022,
    longitude: -118.3267,
    source_url: "https://hollywoodboxing.com"
  },
  {
    id: 3,
    name: "Downtown Fight Club",
    site: "https://dtfightclub.com",
    phone_number: "(213) 555-0345",
    full_address: "789 Spring St, Los Angeles, CA 90013",
    street: "789 Spring St",
    city: "Los Angeles",
    state: "California",
    postal_code: "90013",
    review_count: 32,
    review_stars: 4.7,
    working_hours: "Mon-Fri: 6AM-9PM, Sat-Sun: 9AM-5PM",
    latitude: 34.0522,
    longitude: -118.2437,
    source_url: "https://dtfightclub.com"
  }
]

export default function LosAngelesFreeTrialsPage() {
  // Generate JSON-LD structured data
  const jsonLd = generateItemListJsonLd(
    freeTrialGyms.map(gym => ({
      id: gym.id.toString(),
      name: gym.name,
    ...
    <div className="min-h-screen" style={{backgroundColor: '#FFFFFF'}}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              <div className="text-3xl font-bold text-fight-red mb-2">{freeTrialGyms.length}</div>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-black mb-8">Los Angeles Boxing Gyms Offering Free Trials</h2>
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {freeTrialGyms.length > 0 ? (
              freeTrialGyms.map((gym) => (
                <div key={gym.id} className="relative">
                  <GymCard {...gym} />
                  <div className="absolute top-4 right-4 bg-fight-red text-white px-3 py-1 rounded-full text-sm font-bold">
                    Free Trial
                  </div>
                </div>
              ))
